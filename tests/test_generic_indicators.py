...
class TestFit:
    ...
    def test_options(self, q_series, random, as_da):
...
class TestReturnLevel:
    def test_seasonal(self, ndq_series, as_da):
    ...
    def test_no_indexer(self, ndq_series, as_da):
