...
class Test_frost_days():
    nc_file = 'testdata/NRCANdaily/nrcan_canada_daily_tasmin_1990.nc'
    ...
    def test_3d_data_with_nans(self):
        ...
        thresh = 273.16
        fd = xci.frost_days(tasmin, thresh=thresh, freq='YS', skipna=False)
...
class Test_growing_degree_days():
    nc_file = 'testdata/NRCANdaily/nrcan_canada_daily_tasmax_1990.nc'
    ...
    def test_3d_data_with_nans(self):
        ...
        # compute with both skipna options
        thresh = 277.16
        gdd = xci.growing_degree_days(tas, thresh=thresh, freq='YS', skipna=False)
