...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
* ``utils.py::nan_calc_percentiles`` now uses a custom algorithm instead of ``numpy::nanpercentiles`` to have more flexibility on the interpolation method. The performance is also improved. 
