...
def test_mean():
    sim = open_dataset('sdba/CanESM2_1950-2100.nc').sel(time=slice('1950', '1980'), location='Vancouver').pr
    ...
    np.testing.assert_array_almost_equal(out_season.values, [4.6115547e-05, 1.7220482e-05, 2.8805329e-05, 2.825359e-05])
...
def test_var():
    ...
    np.testing.assert_array_almost_equal(out_season.values,
