...
class TestAgroclimaticIndices:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("MS", 1, "gamma", "ML", [1.4586, 1.6028, 2.0668, -3.09, 0.84841], 1e-2),
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            ("MS", 1, "gamma", "ML", [1.4631, 1.6053, 2.1625, -3.09, 0.87996], 1e-2),
            (
                "MS",
                12,
                "gamma",
            ...
            ("MS", 1, "fisk", "ML", [1.41675, 1.51174, 1.98248, -3.09, 0.942175], 1e-2),
