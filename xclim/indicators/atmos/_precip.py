...
rain_season = PrecipWithIndexing(
    ...
    description=[
        ...
        "with at least {thresh_dry_start} {method_dry_start}. The start of the season is on the last day of the first sequence i) and must be between {date_min_start} and {date_max_start}",
