...
corn_heat_units_accumulation = TasminTasmax(
    ...
    "threshold Tmean >= {seas_start_thresh} for {seas_start_window} days, and ends when the minimum daily "
    "temperature reaches the threshold Tmin <= {seas_end_thresh} for {seas_end_window} day(s).",
    cell_methods="",
    missing="skip",
