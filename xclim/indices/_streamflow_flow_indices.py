...
from xclim.core.units import declare_units, rate2amount, convert_units_to, units
...
@declare_units(q="[discharge]")
def high_flow_frequency(q: xr.DataArray, threshold_factor: int = 9.0, freq: str = "A-SEP", statistic: str = "mean") -> xr.DataArray:
    """
...
def low_flow_frequency(q: xr.DataArray, threshold_factor: float = 0.2, freq: str = "A-SEP", statistic: str = "mean") -> xr.DataArray:
